                            ...
                            <form onSubmit={handleSubmit} className="registration-form">
                                ...
                                {!isLogin && (
                                    <div className="role-selector">
                                        <label className="input-label" id="role-group-label">ACCESS ROLE</label>
                                        <div className="role-options" role="group" aria-labelledby="role-group-label">
                                            {['player', 'viewer'].map((role) => (
                                                <button key={role} type="button" aria-pressed={formData.role === role} className={`role-btn ${formData.role === role ? 'active' : ''}`} onClick={() => setFormData({ ...formData, role })}>
                                                    {role}
                                                </button>
                                            ))}
                                        </div>
