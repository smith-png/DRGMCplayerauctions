...
export default function PlayerProfiles() {
    ...
    // Memoizing the sorted allPlayers array to prevent O(n log n) sorting
    // overhead on every single re-render of this component.
        ...
        <div className="player-profiles-page">
            ...
            <div className="profiles-container">
                ...
                <div className="all-players-section">
                    ...
                    {sortedAllPlayers.length > ITEMS_PER_PAGE_ALL && (
                        <div className="pagination-controls">
                            <button
                                className="page-btn"
                                disabled={allPage === 1}
