...
export default function PlayerProfiles() {
    ...
    // ⚡ Bolt Optimization: Memoize the sorted players list to prevent O(N log N)
    // sorting operations on every re-render. Only recalculate when the players
    // array or sort configuration changes.
