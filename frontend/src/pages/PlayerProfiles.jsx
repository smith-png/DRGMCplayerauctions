...
export default function PlayerProfiles() {
    ...
    // ⚡ Bolt Optimization: Memoize the sorted players list to prevent O(n log n) sorting
    // on every render (e.g., when clicking a player to open the overlay or changing pages).
