...
export default function PlayerProfiles() {
    ...
    // ⚡ Bolt Optimization: Memoize the sorted players array.
    // This prevents an O(N log N) array sort from running on every single component re-render
    // (e.g. when pagination changes or other state updates occur). It now only re-runs
    // when either the player list or the chosen sort criteria changes.
