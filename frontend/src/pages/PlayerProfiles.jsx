...
export default function PlayerProfiles() {
    ...
    // Memoize the sorted players list to prevent expensive sorting on every render
    // ⚡ Bolt: Performance improvement. Avoids O(N log N) sort operation during
    // pagination or modal opens, reducing CPU work and potential lag.
