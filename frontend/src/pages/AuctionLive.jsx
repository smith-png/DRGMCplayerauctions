        ...
        return (
            <div className="sold-banner-overlay">
                <div className="sold-banner-strip">
                    ...
                    {/* Col 5: Dismiss */}
                    {(isAuctioneer || isAdmin) && (
                        <button className="sold-dismiss-btn" aria-label="Dismiss sold animation" onClick={handleDismissSoldAnimation} title="Dismiss">
                            ×
                        </button>
                    )}
                </div>
    ...
    const renderSoldOverlay = () => {
        ...
        return (
            <div className="ledger-overlay-backdrop">
                <button className="dismiss-sold" aria-label="Dismiss sold players ledger" onClick={() => setShowSoldPlayers(false)}>×</button>
