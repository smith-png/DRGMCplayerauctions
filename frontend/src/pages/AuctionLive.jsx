        ...
        return (
            <div className="sold-banner-overlay">
                <div className="sold-banner-strip">
                    ...
                    {/* Col 5: Dismiss */}
                    {(isAuctioneer || isAdmin) && (
                        <button className="sold-dismiss-btn" onClick={handleDismissSoldAnimation} title="Dismiss" aria-label="Dismiss sold animation">
                            ×
                        </button>
                    )}
                </div>
    ...
    const renderSoldOverlay = () => {
        ...
        return (
            <div className="ledger-overlay-backdrop">
                <button className="dismiss-sold" onClick={() => setShowSoldPlayers(false)} aria-label="Close sold players history">×</button>
