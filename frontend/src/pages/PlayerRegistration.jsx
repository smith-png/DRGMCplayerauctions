                    ...
                    <form onSubmit={handleSubmit} className="registration-form">
                        <div className="form-section">
                            ...
                            <div className="input-group">
                                <label className="input-label" htmlFor="name">LEGAL NAME</label>
                                <input
                                    id="name"
                                    type="text"
                                    name="name"
                            ...
                            <div className="dropdowns-row">
                                <div className="input-group">
                                    <label className="input-label" htmlFor="sport">SPORT CATEGORY</label>
                                    <select
                                        id="sport"
                                        name="sport"
                                ...
                                <div className="input-group">
                                    <label className="input-label" htmlFor="year">ACADEMIC YEAR</label>
                                    <select
                                        id="year"
                                        name="year"
                                        value={formData.year}
                                ...
                                {formData.sport === 'cricket' && (
                                    <div className="stats-grid-row fade-in" style={{ gridColumn: 'span 2' }}>
                                        ...
                                        <div className="form-group-minimal">
                                            <label htmlFor="role_primary">PRIMARY ROLE</label>
                                            <select
                                                id="role_primary"
                                                name="role"
