                                    ...
                                    <div key={team.id} className="viewer-team-card">
                                        ...
                                        >
                                            ...
                                            <div className="viewer-team-stats">
                                                ...
                                                <button className="expand-btn" aria-expanded={isExpanded} aria-label={isExpanded ? `Collapse details for ${team.name}` : `Expand details for ${team.name}`}>{isExpanded ? '−' : '+'}</button>
                                            </div>
                                        </div>
                                                        ...
                                                        {team.roster.map(player => (
                                                            <div key={player.id} className="roster-player-row">
                                                                ...
                                                                <button
                                                                    ...
                                                                    aria-label={`Release ${player.name} from team`}
                                                                >
                                                                    ✕
                                                                </button>
                                                            </div>
