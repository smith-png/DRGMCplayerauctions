...
export default function Teams() {
    ...
    // Calculate teams with rosters using useMemo and a hash map for O(N + M) performance
    const teamsWithRosters = useMemo(() => {
        ...
        for (const player of players) {
            if (player.sport?.toLowerCase() === activeSportLower && player.status === 'sold') {
        ...
        return filteredTeams.map(team => ({
            ...team,
            roster: playersByTeam.get(String(team.id)) || []
        }));
