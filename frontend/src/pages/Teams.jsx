...
export default function Teams() {
    ...
    // Bolt Optimization: Memoize the filtering to avoid recalculation
    ...
    // Bolt Optimization: Memoize roster mapping to avoid O(T*P) recalculation on every re-render
