...
export default function Teams() {
    ...
    // ⚡ Bolt: Memoize teamsWithRosters calculation at the top level to avoid expensive array operations on every render,
    // and to comply with React's Rules of Hooks by not calling useMemo inside conditional blocks.
    const teamsWithRosters = useMemo(() => filteredTeams.map(team => {
