...
export default function PlayerProfilesBySport() {
    ...
    // ⚡ Bolt: Removed redundant useEffect and state for filtering, using useMemo instead
    // This prevents unnecessary re-renders when yearFilter changes
                        ...
                        <div className="player-modal-content">
                            ...
                            <div className="modal-info-section">
                                ...
                                <div className="info-item">
                                    ...
                                    <span className="info-value">{selectedPlayer.base_price || 0} PTS</span>
                                </div>
                                <div className="info-item">
                                    <span className="info-label">CURRENT STATUS</span>
                                    <span className="info-value" style={{ textDecoration: 'underline' }}>{selectedPlayer.status?.toUpperCase() || 'UNKNOWN'}</span>
                                </div>
