...
export async function getDashboardStats(req, res) {
    try {
        ...
        // ⚡ Bolt: Execute independent queries concurrently using Promise.all to save network round-trips
        // Expected impact: Reduces latency for fetching dashboard stats from 4 sequential queries to 1 parallel execution.
        const [
            usersResult,
            playersResult,
            teamsResult,
